...
import { SectionTag, UnifiedCard, Reveal, SectionBackground, MobileSwiper } from './ui/Shared';
...
const Overview: React.FC = () => {
  return (
    <section id="overview" className="relative py-20 md:py-32">
      ...
      {/* ATMOSPHERIC BACKGROUND - Architectural Facade */}
      <SectionBackground 
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <MobileSwiper className="grid-cols-1 md:grid-cols-12 mb-12 md:mb-24">
            
            {/* CARD 1: Grundstück (Span 7) */}
