...
import { SectionTag, UnifiedCard, SectionBackground, MobileSwiper } from './ui/Shared';
  ...
  return (
    <section id="finance" className="relative py-20 md:py-32">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        {/* SWIPER FOR MOBILE */}
        <MobileSwiper className="grid-cols-1 lg:grid-cols-12 gap-6 mb-10 md:mb-16">
